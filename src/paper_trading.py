...
if __name__ == "__main__":
    ...
    # ============================================
# COMPTE DE TRADING DÉMO (dans la sidebar)
# ============================================

st.sidebar.markdown("---")
st.sidebar.markdown("<h3 style='color: #00D2FF;'>💰 Compte Démo</h3>", unsafe_allow_html=True)

# Prix actuels pour le portefeuille
current_prices = {crypto_short: current_price}   # <-- CORRIGÉ (accolades)
